...
---------------------- INPUT FILES ---------------------------------------------
"ElastoDyn--PitchOnly.dat"    EDFile          - Name of file containing ElastoDyn input parameters (quoted string)
...
"SrvD_StC-Tow.dat"    ServoFile       - Name of file containing control and electrical-drive input parameters (quoted string)
