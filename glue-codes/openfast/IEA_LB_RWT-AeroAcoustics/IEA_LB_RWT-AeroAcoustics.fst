...
1.81206E-05   KinVisc         - Kinematic viscosity of working fluid (m^2/s)
...
---------------------- INPUT FILES ---------------------------------------------
"RotorSE_FAST_IEA_landBased_RWT_ElastoDyn.dat"    EDFile          - Name of file containing ElastoDyn input parameters (quoted string)
...
"RotorSE_FAST_IEA_landBased_RWT_InflowFile.dat"    InflowFile      - Name of file containing inflow wind input parameters (quoted string)
"RotorSE_FAST_IEA_landBased_RWT_AeroDyn15.dat"    AeroFile        - Name of file containing aerodynamic input parameters (quoted string)
"RotorSE_FAST_IEA_landBased_RWT_ServoDyn.dat"    ServoFile       - Name of file containing control and electrical-drive input parameters (quoted string)
