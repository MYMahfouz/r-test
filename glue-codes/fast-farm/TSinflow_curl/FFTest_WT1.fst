...
---------------------- INPUT FILES ---------------------------------------------
"ED_WT1.dat"  EDFile          - Name of file containing ElastoDyn input parameters (quoted string)
...
"SvD_WT1.dat" ServoFile       - Name of file containing control and electrical-drive input parameters (quoted string)
...
False         SumPrint        - Print summary data to "<RootName>.sum" (flag)
      ...
      99999   ChkptTime       - Amount of time between creating checkpoint files for potential restart (s)
        0.2   DT_Out          - Time step for tabular output (s) (or "default")
