...
---------------------- INPUT FILES ---------------------------------------------
"ED_WT2.dat"  EDFile          - Name of file containing ElastoDyn input parameters (quoted string)
...
"SvD_WT2.dat" ServoFile       - Name of file containing control and electrical-drive input parameters (quoted string)
